...
次に、「VORP」を使用して塗りつぶし色をエンコードします。VORP値には正と負の両方の数値が含まれるため、Data Illustrateur はデフォルトで発散カラースケールを選択します。その後、背景色を黒に設定し、X軸の向きを上に変更します。最後に、軸と凡例の色を薄い灰色に変更して、暗い背景から目立つようにします。
